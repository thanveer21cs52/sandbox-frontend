...
import { headers } from "next/headers";
import { fetchData } from "../../utils/fetch";
import HeaderClient from "./haederclient";
...
export default async function Header() {
  ...
  // Example fetchEmails function
  // const fetchEmails = async () => {
  //   // Replace this with your API call to fetch sent emails
  //   return [
  //     { id: "1", email: "user@example.com", subject: "Hello", sent_at: new Date().toISOString() },
  //   ];
  // };
  console.log(data,"akg")

  return (
   <HeaderClient
  logoUrl={data.url}
  nav={data.nav[0] ? Object.values(data.nav[0]) : []}
  social={data.social || []}
/>
