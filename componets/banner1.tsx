    ...
    return (
        <div  className=" bg-bg text-base-text pt-[11vh] pb-8">
            <div className="flex justify-between ">
                            <div className="flex  flex-col justify-start py-12 items-start  flex-5/10   gap-5 text-dark-base ps-40 ">
                ...
                <div className="flex justify-between items-center gap-3  text-sm font-medium ">
                    <button className="text-bg bg-button-purple px-6 py-3 rounded-full ">{data.button1}</button>
                     <button className="text-button-purple  border-2 border-button-purple px-6 py-3 rounded-full ">{data.button2}</button>
                </div>
            </div>
