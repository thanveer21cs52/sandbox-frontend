...
async function Banner3() {
  ...
  viewBox="0 0 507 512"
  className={` h-8 w-8 text-button-purple mb-3 `}
  fill="none"
>
  ...
  <svg
    ...
    className='h-8 w-8 text-button-purple mb-4'
    fill="none"
    stroke="currentColor"
  >
    {/* Outer shield stroke */}
 ...
 <svg
    ...
    className="h-8 w-8 text-black mb-3"
  >
    {/* Cloud Outline */}
    <path
      className="fill-current"
  ...
  >
    ...
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
      className='w-8 h-8  fill-button-purple mb-3'
    
    >
      <circle className="fill-current opacity-20" cx="256" cy="256" r="112.5" />
      <path
        className="fill-black"
        fill="text-black"
        strokeWidth="16"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 gap-7 text-sm  pb-16 border-b border-b-purple-100">
                {
                    data.map((dt:any,key:number)=>{
                        return <div key={key} className="flex p-0 m-0 gap-5 lg:gap-2"> 
                        <div className="w-fit lg:flex-2/12">
                        {icons[key]}
                        
                        
                        </div>
                         <div className="flex-10/12 flex flex-col jus gap-2 text-xsp-0 m-0 ">
                         <p className="font-medium text-lg">{dt.title}</p>
                          <p className=" text-sm text-gray-500">{dt.subtitle}</p>
